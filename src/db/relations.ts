...
export const usersInAuthRelations = relations(usersInAuth, ({ many }) => ({
  ...
  users_id: many(users, { relationName: "users_id_usersInAuth_id" }),
  admins_id: many(admins, { relationName: "admins_id_usersInAuth_id" }),
  profiles_id: many(profile, { relationName: "profile_id_usersInAuth_id" }),
